...
public class CardioRecordsDAOTest {
    ...
    public static void setUp() throws Exception {
        ...
        for (int i = 0; i < 10 ; i++) {
            CardioRecordsDAO.addRecord(1,USR,100,Time.valueOf("8:15:30"),i); //Value that changes is repetitions
            Thread.sleep(1000);
        }
    }
    ...
    public void addRecord() throws Exception {
        ...
        Assert.assertTrue( CardioRecordsDAO.addRecord(2,USR,100,Time.valueOf("8:15:30"),0) );
        Thread.sleep(1000);
        Assert.assertFalse( CardioRecordsDAO.addRecord(2,USR,-1,Time.valueOf("8:15:30"),0) );
        Thread.sleep(1000);
        Thread.sleep(1000);
        Assert.assertFalse( CardioRecordsDAO.addRecord(0,USR,100,Time.valueOf("8:15:30"),0) );
        Thread.sleep(1000);
        Assert.assertFalse( CardioRecordsDAO.addRecord(2,"",100,Time.valueOf("8:15:30"),0) );
        Thread.sleep(1000);
        Assert.assertFalse( CardioRecordsDAO.addRecord(2,"NONEXISTINGUSER",100,Time.valueOf("8:15:30"),0) );
